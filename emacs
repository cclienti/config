...
(use-package verilog-mode
  ...
  (defun svmodp-command (command get-value)
    (let (value)
      ...
      (when get-value
        (insert value))))
  (defun svmodp-reverse () (interactive) (svmodp-command "reverse" nil))
  (defun svmodp-paste-as-module () (interactive) (svmodp-command "paste-as-module" t))
  (defun svmodp-paste-as-packages () (interactive) (svmodp-command "paste-as-packages" t))
  (defun svmodp-paste-as-instance () (interactive) (svmodp-command "paste-as-instance" t))
  (defun svmodp-paste-as-clockingblock () (interactive) (svmodp-command "paste-as-clockingblock" t))
  (defun svmodp-paste-as-parameters () (interactive) (svmodp-command "paste-as-parameters" t))
  (defun svmodp-paste-as-signals () (interactive) (svmodp-command "paste-as-signals" t))
  (defun svmodp-paste-as-logic () (interactive) (svmodp-command "paste-as-logic" t))
  (defun svmodp-paste-as-init-latch () (interactive) (svmodp-command "paste-as-init-latch" t))
  (defun svmodp-paste-as-init-wire () (interactive) (svmodp-command "paste-as-init-wire" t))
  (defun svmodp-paste-as-doc-table () (interactive) (svmodp-command "paste-as-doc-table" t))
  (defun svmodp-paste-as-wavedisp () (interactive) (svmodp-command "paste-as-wavedisp" t))
  (define-key verilog-mode-map (kbd "M-p M-w") #'svmodp-copy)
  (define-key verilog-mode-map (kbd "M-p M-r") #'svmodp-reverse)
  (define-key verilog-mode-map (kbd "M-p M-m") #'svmodp-paste-as-module)
  (define-key verilog-mode-map (kbd "M-p M-g") #'svmodp-paste-as-packages)
  (define-key verilog-mode-map (kbd "M-p M-i") #'svmodp-paste-as-instance)
  (define-key verilog-mode-map (kbd "M-p M-b") #'svmodp-paste-as-clockingblock)
  (define-key verilog-mode-map (kbd "M-p M-c") #'svmodp-paste-as-parameters)
  (define-key verilog-mode-map (kbd "M-p M-s") #'svmodp-paste-as-signals)
  (define-key verilog-mode-map (kbd "M-p M-o") #'svmodp-paste-as-logic)
  (define-key verilog-mode-map (kbd "M-p M-l") #'svmodp-paste-as-init-latch)
  (define-key verilog-mode-map (kbd "M-p M-a") #'svmodp-paste-as-init-wire)
  (define-key verilog-mode-map (kbd "M-p M-t") #'svmodp-paste-as-doc-table)
  (define-key verilog-mode-map (kbd "M-p M-y") #'svmodp-paste-as-wavedisp))
